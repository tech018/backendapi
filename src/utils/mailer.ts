...
<html>
  ...
  <body>
    <span class="preheader">Greetings from Zep Network and Data Solution.</span>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="${config.frontendURL}/auth/activate?email=${email}&otp=${otp}" target="_blank">Continue</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Zep Network and Data Solution, Sinilian Cacalibosoan Camiling, Tarlac</span>
